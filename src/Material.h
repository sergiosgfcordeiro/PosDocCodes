...
class Material : public Object
{
 public:
  ...
  inline bool             usesSecant        ( const idx_t ipoint ) const;

  inline bool             inDesperateMode   ( ) const;
...
inline bool Material::usesSecant ( const idx_t ipoint ) const
{
  return useSecant_[ipoint];
}

inline bool Material::inDesperateMode () const
{
  return desperateMode_;
}
