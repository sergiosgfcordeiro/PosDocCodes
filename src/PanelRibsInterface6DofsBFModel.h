...
class PanelRibsInterface6DofsBFModel : public Model
{
 public:

  typedef PanelRibsInterface6DofsBFModel     Self;
  typedef Model              Super;
  ...
  static const char*         RIB_NAME_PROP;
                       ...
                       PanelRibsInterface6DofsBFModel
 ...
 protected:
  ...
  virtual              ~PanelRibsInterface6DofsBFModel ();
...
protected: 
  ...
  Ref<Shell6DofsBFModel>  shell_[2];
