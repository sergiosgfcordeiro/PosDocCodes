...
#ifndef ZOU_TURON_COHE_MAT_H
#define ZOU_TURON_COHE_MAT_H
...
class ZouTuronCoheMat : public virtual CohesiveMat
{
 public:
...
inline double  ZouTuronCoheMat::giveHistory ( idx_t ipoint ) const
{
...
inline idx_t   ZouTuronCoheMat::isLoading ( idx_t ipoint ) const
{
...
inline idx_t   ZouTuronCoheMat::wasLoading ( idx_t ipoint )  const
{
...
inline double  ZouTuronCoheMat::giveDissipation ( idx_t ipoint ) const
{
...
inline double  ZouTuronCoheMat::getDummy ( ) const
{
  return dummy_;
}
...
inline idx_t ZouTuronCoheMat::loadingCount () const
{
  idx_t ret = 0;
