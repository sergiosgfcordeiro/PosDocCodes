...
#ifndef SHELL6DOFSBF_MODEL_H
#define SHELL6DOFSBF_MODEL_H
...
//=======================================================================
//   class Shell6DofsBFModel
//=======================================================================

// Forward declaration
class StructuralInterfaceModel;
class PanelRibsInterface6DofsBFModel;


class Shell6DofsBFModel : public Model
{
 friend class StructuralInterfaceModel; 
 friend class PanelRibsInterface6DofsBFModel; 

 public:

  typedef Shell6DofsBFModel    Self;
  typedef Model              Super;
