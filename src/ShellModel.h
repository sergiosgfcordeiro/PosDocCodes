 ...
 *
 *  
 *  This class implements the triangular Kirchhoff-Love shell element developed for orthotropic materials to model
 *   the plies in laminated composites. 
 *  
...
#ifndef SHELL_MODEL_H
#define SHELL_MODEL_H
...
class PanelRibsInterfaceModel;


class ShellModel : public Model
{
 friend class StructuralInterfaceModel; 
 friend class PanelRibsInterfaceModel; 

 public:

  typedef ShellModel         Self;
  typedef Model              Super;
