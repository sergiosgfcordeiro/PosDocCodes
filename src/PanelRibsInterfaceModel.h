...
class PanelRibsInterfaceModel : public Model
{
 public:

  typedef PanelRibsInterfaceModel     Self;
  typedef Model              Super;
 ...
 protected:
  ...
  virtual              ~PanelRibsInterfaceModel ();
